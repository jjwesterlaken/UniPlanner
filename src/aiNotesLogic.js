...
import { providerBullets, providerFingerprint } from "./aiProviders.js";
...
/* V7 NAMES THE THIRD PARTIES, and it is a rejection rather than a
   ...
   The provider names come from src/aiProviders.js and are NOT written
   out here, so this text cannot name a service the code does not use,
   or miss one it can. */
...
export const CONSENT_TEXT = {
  ...
  intro:
    "The AI features send some of your work to companies outside Australia to do the thing you asked for. " +
    "Here is exactly what goes where.",
  /* WHO, BY NAME, FIRST. The rejection was about this list being
     absent, and a student reading top-down should meet the recipients
     before the caveats. Built from aiProviders.js. */
  providersHeading: "What is sent, and who receives it",
  providers: providerBullets(),
  bullets: [
    "Your recording is deleted as soon as it has been transcribed. It is never kept by us or by the transcription service.",
    `A copy of the transcript and the notes stays on our server in Sydney for ${RESULT_RETENTION_DAYS} days so you can get them back if something goes wrong — or ${FAILED_RESULT_RETENTION_DAYS} days if we could not finish, so nothing you paid for is lost. Notes you save into your planner are yours until you delete them.`,
    "Text and photos you supply are relayed and not stored: not in your planner, not on our server. Only the result is saved, and only if you save it.",
    "These notes and answers are generated by AI to help you study. They can be wrong, and they are not a substitute for your own work.",
    "If you record a lecture, you are responsible for having permission. Many universities require the lecturer's consent, and recording someone without permission may be unlawful in some Australian states.",
  ...
  declineNote:
    "You do not have to agree. Everything else in University Planner — your timetable, assessments, grades, notes, readings and study cards — works exactly the same either way. Only the AI features need this.",
  ...
  stubLine:
    "The AI study features need your agreement first: they send your work to companies outside Australia to do what you asked.",
