...
export const AI_CONSENT_VERSION = 5;
...
export const CONSENT_TEXT = {
  ...
  bullets: [
    ...
    "Some AI features work on text you supply — a note you wrote, your study cards, an explanation you type, or a section of a reading you paste in. When you use one, that text is sent overseas to the same summarising service to do what you asked, and it is not stored: not in your planner and not on our server. Only the result is saved, and only if you save it.",
